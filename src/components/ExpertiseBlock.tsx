          ...
          <>
            ...
            >
              <img
                src={image}
                alt={bgWord}
                className={`block w-full ${mobileContain ? 'h-auto md:h-full object-contain md:object-cover' : 'h-full object-cover'}`}
                style={{ mixBlendMode: 'multiply', objectPosition: imagePosition || (mobileContain ? 'center center' : 'center 15%') }}
              />
            </div>
