const Navigation = () => {
  return (
    <nav className="fixed top-0 left-0 right-0 z-[1000] flex items-center justify-between px-[44px] py-[22px]">
      ...
      <div className="flex items-center gap-5">
        <a
          href="#contacto"
          className="inline-block border border-foreground/[0.35] text-foreground font-body text-[12px] font-medium tracking-[0.03em] px-[22px] py-[10px] rounded-full no-underline transition-all duration-[250ms] hover:bg-foreground hover:text-background"
        >
          Trabaja Conmigo
        </a>
