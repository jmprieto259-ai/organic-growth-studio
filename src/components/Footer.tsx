...
const Footer = () => {
  ...
  return (
    <footer id="contacto" className="bg-background border-t border-foreground/10 px-[60px] pt-20 pb-10">
      <div
        ref={ref}
        className="grid grid-cols-[1fr_1fr_1.4fr] gap-[60px] mb-[60px]"
      >
        {/* Contact */}
        <div
        ...
        >
          <h3 className="font-display font-black uppercase text-foreground mb-[18px]" style={{ fontSize: 'clamp(16px, 1.8vw, 22px)', letterSpacing: '-0.02em' }}>
            Trabaja Conmigo
          </h3>
          <p className="font-body text-[11px] tracking-[0.12em] uppercase mb-[10px]" style={{ color: 'rgba(255,255,255,0.38)' }}>Contacto</p>
          <a href="mailto:jm.prieto259@gmail.com" className="block font-body text-[13px] no-underline leading-[1.80] transition-colors duration-200 hover:text-foreground" style={{ color: 'rgba(255,255,255,0.38)' }}>jm.prieto259@gmail.com</a>
